...
<template>
  <div class="form">
    <el-form ref="form" label-position="left" :rules="rules" :model="value" label-width="110px" size="mini">
      <el-row>
        <el-col :span='24'>
          ...
          <template v-if="transferMode === 'rtu' && isModeReady">
            ...
            <el-col :span='12'>
              <el-form-item label="dataBits">
                <el-input v-model="value.spec.template.spec.protocolConfig[transferMode].dataBits"></el-input>
              </el-form-item>
            </el-col>

            <el-col :span='12'>
              <el-form-item label="parity">
                <el-input v-model="value.spec.template.spec.protocolConfig[transferMode].parity"></el-input>
              </el-form-item>
            </el-col>

            <el-col :span='12'>
              <el-form-item label="stopBits">
                <el-input v-model="value.spec.template.spec.protocolConfig[transferMode].stopBits"></el-input>
              </el-form-item>
            </el-col>
          </template>
